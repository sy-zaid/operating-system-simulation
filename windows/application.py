...
class ApplicationOpener:
    ...
    input-parameters:
    - inp_choice: To choose between the applications 1/2/3

    subprocess: It creates a process and runs it.
    """
    def open_application(self):
        print("Choose an Application to Open:\n1. Google Chrome\n2. Microsoft Edge\n3. Task Manager")
        inp_choice = input("Choose an option (1-3) OR type 'cancel' to cancel the operation # ")  # User will input the respective number
        if inp_choice == "1": # Will compare the input
